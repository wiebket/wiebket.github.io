...
<a href="https://people.cs.uct.ac.za/~deshen/" target="_blank">Assoc. Prof. Deshen Moodley</a> and [Prof. Tommie Meyer](https://people.cs.uct.ac.za/~tmeyer/prof-biography.html){:target="\_blank"}. My masters work investigated unsupervised machine learning techniques for generating representative household energy consumption patterns in South Africa, a developing country with a highly variable population. In particular, I demonstrated that nuanced and context-specific qualitative evaluation measures informed by expert insights can support the evaluation of clustering models in a real-world application.
